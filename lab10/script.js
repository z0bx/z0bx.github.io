...
const wordList = [
  ...
  { word: "ГОВЬ", hint: "Монголын алдартай цөл" },
  { word: "ХАРХОРИН", hint: "Эзэн Чингис хааны үеийн эртний нийслэл" },
  { word: "ДЭЭЛ", hint: "Монгол үндэсний хувцас" },
  { word: "ЧИНГИС", hint: "Дэлхийг байлдан дагуулсан Монгол хаан" },
  { word: "МОРИНХУУР", hint: "Монгол үндэсний хөгжмийн зэмсэг" },
  { word: "НААДАМ", hint: "Үндэсний их баяр наадам" },
  { word: "ЦАГААН", hint: "Монгол хэлний 'цагаан' өнгө" },
  { word: "БӨӨ", hint: "Монголын уламжлалт шашинтны нэр" },
  { word: "ХӨДӨӨ", hint: "Хот суурингаас зайтай нутаг дэвсгэр" },
  { word: "ТЭМЭЭ", hint: "Говийн тэсвэртэй амьтан" }
...
const showLeaderboardButtonGameOver = document.getElementById(
  "show-leaderboard-button-gameover"
);
const showLeaderboardButtonWin = document.getElementById(
  "show-leaderboard-button-win"
);
const showLeaderboardButtonTimeUp = document.getElementById(
  "show-leaderboard-button-timeup"
);
...
function checkGuess(letter) {
  ...
  if (currentWord.includes(letter)) {
    ...
    if (wrongGuesses <= hangmanParts.length) {
      document.getElementById(hangmanParts[wrongGuesses - 1]).style.display =
        "block";
    }
...
function endGame(result) {
    ...
    if (result === 'win') {
        ...
        // Update leaderboard when player loses
        updateLeaderboard();
